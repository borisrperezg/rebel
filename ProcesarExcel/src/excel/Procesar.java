...
//	    		System.out.println(nombreCliente + " - " + salonString);
		...
		clientes.entrySet().forEach(entry->{
		    System.out.println(entry.getKey() + "|" + 
		    		entry.getValue().getTerracota() + "|" + entry.getValue().getVecesTerracota() + "|" +  
		    		entry.getValue().getCian() + "|" + entry.getValue().getVecesCian() + "|" +
		    		entry.getValue().getAmbar() + "|" + entry.getValue().getVecesAmbar() + "|" +
		    		entry.getValue().getRubi() + "|" + entry.getValue().getVecesRubi() + "|" +
		    		entry.getValue().getMarfil() + "|" + entry.getValue().getVecesMarfil() + "|" +
		    		entry.getValue().getCarmesi() + "|" + entry.getValue().getVecesCarmesi() + "|" +
		    		entry.getValue().getMagenta() + "|" + entry.getValue().getVecesMagenta() + "|" +
		    		entry.getValue().getZafiro() + "|" + entry.getValue().getVecesZafiro() + "|" +
		    		entry.getValue().getCoral() + "|" + entry.getValue().getVecesCoral() + "|" +
		    		entry.getValue().getGranate() + "|" + entry.getValue().getVecesGranate() + "|" +
		    		entry.getValue().getJade() + "|" + entry.getValue().getVecesJade() + "|" +
		    		entry.getValue().getSalaJuntas() + "|" + entry.getValue().getVecesSalaJuntas() + "|" +
		    		entry.getValue().getCampestre() + "|" + entry.getValue().getVecesCampestre());
		 });
