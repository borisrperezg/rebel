 ...
 * </p>
 * <ul>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getPosX <em>Pos X</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getPosY <em>Pos Y</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#isGrouper <em>Grouper</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getSync <em>Sync</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getDelivery <em>Delivery</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getNotification <em>Notification</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getBuffering <em>Buffering</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link rebel_archimate.impl.ElementImpl#getApplicationServiceType <em>Application Service Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	protected EClass eStaticClass() {
		return Rebel_archimatePackage.Literals.ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__NAME, oldName, name));
	}
	...
	public void setPosX(int newPosX) {
		...
		posX = newPosX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__POS_X, oldPosX,
					posX));
	}
	...
	public void setPosY(int newPosY) {
		...
		posY = newPosY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__POS_Y, oldPosY,
					posY));
	}
	...
	public void setWidth(int newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__WIDTH, oldWidth,
					width));
	}
	...
	public void setHeight(int newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__HEIGHT, oldHeight,
					height));
	}
	...
	public void setType(ELEMENTTYPE newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__TYPE, oldType, type));
	}
	...
	public void setGrouper(boolean newGrouper) {
		...
		grouper = newGrouper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__GROUPER, oldGrouper,
					grouper));
	}
	...
	public void setSync(SyncType newSync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__SYNC, oldSync, sync));
	}
	...
	public void setDelivery(DeliveryModel newDelivery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__DELIVERY, oldDelivery,
					delivery));
	}
	...
	public void setNotification(NotificationModel newNotification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__NOTIFICATION,
	...
	public void setBuffering(Buffering newBuffering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__BUFFERING,
	...
	public void setThroughput(Throughput newThroughput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_archimatePackage.ELEMENT__THROUGHPUT,
	...
	public void setApplicationServiceType(APPLICATIONSERVICETYPE newApplicationServiceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Rebel_archimatePackage.ELEMENT__APPLICATION_SERVICE_TYPE, oldApplicationServiceType,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Rebel_archimatePackage.ELEMENT__ID:
			return getId();
		case Rebel_archimatePackage.ELEMENT__NAME:
			return getName();
		case Rebel_archimatePackage.ELEMENT__POS_X:
			return getPosX();
		case Rebel_archimatePackage.ELEMENT__POS_Y:
			return getPosY();
		case Rebel_archimatePackage.ELEMENT__WIDTH:
			return getWidth();
		case Rebel_archimatePackage.ELEMENT__HEIGHT:
			return getHeight();
		case Rebel_archimatePackage.ELEMENT__TYPE:
			return getType();
		case Rebel_archimatePackage.ELEMENT__GROUPER:
			return isGrouper();
		case Rebel_archimatePackage.ELEMENT__SYNC:
			return getSync();
		case Rebel_archimatePackage.ELEMENT__DELIVERY:
			return getDelivery();
		case Rebel_archimatePackage.ELEMENT__NOTIFICATION:
			return getNotification();
		case Rebel_archimatePackage.ELEMENT__BUFFERING:
			return getBuffering();
		case Rebel_archimatePackage.ELEMENT__THROUGHPUT:
			return getThroughput();
		case Rebel_archimatePackage.ELEMENT__APPLICATION_SERVICE_TYPE:
