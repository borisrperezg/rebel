...
public class IdentificationMediator {
	...
	final String DATAFILESFOLDER = "/Users/borisperezg/rebelmodels_storing/datasets_to_classify/";
...
//		String fileContent = "date,prevelementnames,types,relationtypes,sourceelementname,sourceelementtype,targetelementname,isnewelement,targetelementtype,facttype,relatontype,action,atdcause\n";
		...
		String fileContent = "driver|goal|sourceelementname|sourceelementtype|layersource|targetelementname|targetelementtype|layertarget|isnewelement|facttype|relatontype|action|incoming|outcoming|ratioLinks|mostlinkedlayer|commitlogs|adrlogs|chatlogs\n";
		...
		System.out.println("IdentificationMediator.prepareDatasetToClassify ::: Extraccion del nombre del proyecto -> OK");
...
//		System.out.println("ModelMediator.trainingModel ::: Obtencion de categorias -> OK ");
		...
		System.out.println("IdentificationMediator.prepareDatasetToClassify ::: Extraccion del total de relaciones  -> OK "+(hashRelaciones!=null));
			...
			for (BlockOfInterest boi : project.getBlockofinterest()) {
				...
				for (Fact f : boi.getFact()) {
					...
					if(!f.getElementType().equals("Component") && !f.getElementType().equals("Connector")) {
						...
						System.out.println("IdentificationMediator.prepareDatasetToClassify ::: Fact ID -> "+f.getId() + " ("+f.getElementType()+")");
...
//						System.out.println("adrMsgsText = "+adrMsgsText);
	...
	//					String fileContent = "driver,goal,sourceelementname,sourceelementtype,layersource,targetelementname,targetelementtype,layertarget,isnewelement,facttype,relatontype,action,incoming,outcoming,ratioLinks,mostlinkedlayer,atdcause\n";
							...
							fileContent += driver + separador + goal + separador + origen + separador + 
									...
									adrMsgsText + separador + chatEmailMsgsText + "\n";
					}
				}
			}
		}
