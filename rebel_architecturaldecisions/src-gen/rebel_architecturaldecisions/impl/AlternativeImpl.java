 ...
 * </p>
 * <ul>
 *   <li>{@link rebel_architecturaldecisions.impl.AlternativeImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlternativeImpl extends MinimalEObjectImpl.Container implements Alternative {
	...
	protected EClass eStaticClass() {
		return Rebel_architecturaldecisionsPackage.Literals.ALTERNATIVE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Rebel_architecturaldecisionsPackage.ALTERNATIVE__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Rebel_architecturaldecisionsPackage.ALTERNATIVE__DESCRIPTION:
