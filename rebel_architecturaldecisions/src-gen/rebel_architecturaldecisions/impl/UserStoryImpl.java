 ...
 * </p>
 * <ul>
 *   <li>{@link rebel_architecturaldecisions.impl.UserStoryImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserStoryImpl extends MinimalEObjectImpl.Container implements UserStory {
	...
	protected EClass eStaticClass() {
		return Rebel_architecturaldecisionsPackage.Literals.USER_STORY;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rebel_architecturaldecisionsPackage.USER_STORY__ID,
					oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Rebel_architecturaldecisionsPackage.USER_STORY__ID:
			return getId();
		}
