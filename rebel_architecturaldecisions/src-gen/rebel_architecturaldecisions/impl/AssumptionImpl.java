 ...
 * </p>
 * <ul>
 *   <li>{@link rebel_architecturaldecisions.impl.AssumptionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssumptionImpl extends MinimalEObjectImpl.Container implements Assumption {
	...
	protected EClass eStaticClass() {
		return Rebel_architecturaldecisionsPackage.Literals.ASSUMPTION;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Rebel_architecturaldecisionsPackage.ASSUMPTION__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Rebel_architecturaldecisionsPackage.ASSUMPTION__DESCRIPTION:
